...
[JS Bin: Listing 5.01](http://jsbin.com/taqusi/edit?js,console) - taqusi
```javascript
...
[JS Bin: Listing 5.02](http://jsbin.com/yaresa/edit?js,console) - yaresa
```javascript
/* Get Programming with JavaScript
 * Listing 5.02
 * Breaking a function by changing a variable name
...
[JS Bin: Listing 5.03](http://jsbin.com/xucemu/edit?js,console) - xucemu
```javascript
/* Get Programming with JavaScript
 * Listing 5.03
 * Passing information to a function
...
[JS Bin: Listing 5.04](http://jsbin.com/zavavo/edit?js,console) - zavavo
```javascript
/* Get Programming with JavaScript
 * Listing 5.04
 * Calling the same function with different arguments
...
[JS Bin: Listing 5.05](http://jsbin.com/vequpi/edit?js,console) - vequpi
```javascript
/* Get Programming with JavaScript
 * Listing 5.05
 * Using the square function
...
[JS Bin: Listing 5.06](http://jsbin.com/siyelu/edit?js,console) - siyelu
```javascript
/* Get Programming with JavaScript
 * Listing 5.06
 * A function with two arguments
...
[JS Bin: Listing 5.07](http://jsbin.com/yubahi/edit?js,console) - yubahi
```javascript
/* Get Programming with JavaScript
 * Listing 5.07
 * Displaying a player's name
...
[JS Bin: Listing 5.08](http://jsbin.com/juhewi/edit?js,console) - juhewi
```javascript
/* Get Programming with JavaScript
 * Listing 5.08
 * Displaying a player's name via an object property
...
[JS Bin: Listing 5.09](http://jsbin.com/nomija/edit?js,console) - nomija
```javascript
/* Get Programming with JavaScript
 * Listing 5.09
 * Displaying a player's health
...
[JS Bin: Listing 5.10](http://jsbin.com/zufoxi/edit?js,console) - zufoxi
```javascript
/* Get Programming with JavaScript
 * Listing 5.10
 * Displaying a player's health via object properties
...
[JS Bin: Listing 5.11](http://jsbin.com/yifahe/edit?js,console) - yifahe
```javascript
/* Get Programming with JavaScript
 * Listing 5.11
 * Displaying a player's location
...
[JS Bin: Listing 5.12](http://jsbin.com/mejuki/edit?js,console) - mejuki
```javascript
/* Get Programming with JavaScript
 * Listing 5.12
 * Displaying a player's location via object properties
...
[JS Bin: Listing 5.13](http://jsbin.com/likafe/edit?js,console) - likafe
```javascript
/* Get Programming with JavaScript
 * Listing 5.13
 * Displaying a player's information
...
[JS Bin: Listing 5.14](http://jsbin.com/loteti/edit?js,console) - loteti
```javascript
/* Get Programming with JavaScript
 * Listing 5.14
 * Displaying a player's information using properties
